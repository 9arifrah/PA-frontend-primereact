            ...
            <div id="home" className="landing-wrapper overflow-hidden">
                <div className="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 flex align-items-center justify-content-between relative lg:static">
                    <Link href="/" className="flex align-items-center">
                        <img src={`/layout/images/${layoutConfig.colorScheme === 'light' ? 'logo-rajawali' : 'logo-white'}.png`} alt="Sakai Logo" height="50" className="mr-0 lg:mr-2" />
                ...
                >
                    <div className="mx-4 md:mx-8 mt-0 md:mt-4">
                        ...
                        <p className="font-normal text-2xl line-height-3 md:mt-3 text-gray-700">Kualitas dan funksionalitas adalah hal yang kami utamakan,<br></br> karena kami memiliki pekerja prefesional dibidangnya,<br></br> kami memilih bahan kayu jati dengan kualitas tinggi<br></br>dan bisa disesuaikan dengan keinginan pelanggan.</p>
                        <Link href="/auth/login">
                    ...
                    <div className="flex justify-content-center md:justify-content-end">
                        <img src="/demo/images/landing/landing-img.png" alt="Hero Image" className="w-9 md:w-auto" />
                    </div>
                </div>
                ...
                <div id="highlights" className="py-4 px-4 lg:px-8 mx-0 my-6 lg:mx-8">
                    <div className="text-center">
                        <h2 className="text-900 font-normal mb-2">Aplikasi Mobile Rajawali Mebel</h2>
                        {/* <span className="text-600 text-2xl">Amet consectetur adipiscing elit...</span> */}
                    </div>

                    <div className="grid mt-8 pb-2 md:pb-8">
                        <div className="flex justify-content-center col-12 lg:col-5 bg-purple-100 p-0 flex-order-1 lg:flex-order-0" style={{ borderRadius: '8px' }}>
                            <img src="/demo/images/landing/mockup-mobile.png" className="w-5" alt="mockup mobile" />
                        </div>
                        ...
                        <div className="col-12 lg:col-6 my-auto flex flex-column lg:align-items-end text-center lg:text-right">
                            ...
                            <h2 className="line-height-1 text-900 text-4xl font-normal">Aplikasi Pemantauan Progres Pengerjaan Pesanan</h2>
                            <span className="text-700 text-2xl line-height-3 ml-0 md:ml-2" style={{ maxWidth: '650px' }}>
                                Melalui aplikasi Rajawali Mebel anda dapat memantau progres pengerjaan barang yang ada pesan dengan mudah.<br></br> Download sekarang. GRATIS!
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="grid my-8 pt-2 md:pt-8">
                        <div className="col-12 lg:col-6 my-auto flex flex-column text-center lg:text-left lg:align-items-start">
                            ...
                            <h2 className="line-height-1 text-900 text-4xl font-normal">Aplikasi Pelaporan Progres Pengerjaan Pesanan</h2>
                            <span className="text-700 text-2xl line-height-3 mr-0 md:mr-2" style={{ maxWidth: '650px' }}>
                                Aplikasi berbasis website yang dikhususkan untuk admin atau owner Rajawali Mebel agar lebih mudah dalam memanajemen laporan progres pengerjaan pesanan.
                            </span>
                        </div>
                        ...
                        <div className="flex justify-content-end flex-order-1 sm:flex-order-2 col-12 lg:col-6 bg-yellow-100 p-0" style={{ borderRadius: '8px' }}>
                            <img src="/demo/images/landing/mockup-laptop.png" className="w-11" alt="mockup" />
                        </div>
                    </div>
                </div>
